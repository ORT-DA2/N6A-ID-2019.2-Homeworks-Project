...
Ahora vamos a Módulos y nos fijamos si tenemos instalado el modulo "AspNetCoreModule" si no es el caso vamos [aquí](https://www.microsoft.com/net/download) y descargamos **.NET Core Runtime**
...
6) Ahora vamos a Application Pools (encima de Sitios) y buscamos el pool que le asignamos al sitio (por lo general el nombre de este) y hacemos clic en este en .NET CLR Version seleccionamos No Managed Code aceptamos y listo
...
* [Aulas Guiá](https://aulas.ort.edu.uy/pluginfile.php/327939/mod_resource/content/1/Deploy%20Ob1.pdf)
